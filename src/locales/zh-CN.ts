...
export const zhCN = {
  ...
  calNextMonth: '下个月',
  calToday: '今天',
  calKeyboardHint: '方向键在日期间移动，Home与End跳到本月首日或末日，PageUp与PageDown切换月份，Shift+PageUp与Shift+PageDown切换年份，回车或空格选择日期。',
  calSelectYear: '选择年份',
  calSelectMonth: '选择月份',
  calYearMonthKeyboardHint: '使用方向键在年份与月份间移动，Home与End跳到首项或末项，回车或空格选择，Esc返回日历。',
